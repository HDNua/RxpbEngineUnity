...
/// </summary>
public class StageManager2P : HDSceneManager
{
    ...
    /// 스테이지 관리자입니다.
    /// </summary>
    public static StageManager2P Instance
    {
        get
        {
            return GameObject.FindGameObjectWithTag("StageManager").GetComponent<StageManager2P>();
        }
    }
    ...
    /// 주 플레이어 개체입니다.
    /// </summary>
    public PlayerController MainPlayer { get { return _players[0]; } }
    /// <summary>
    /// 부 플레이어 개체입니다.
    /// </summary>
    ...
    protected override void Start()
    {
        ...
        // 맵 데이터를 초기화합니다.
        _playerSpawnPosition = _checkpointSpawnPositions
    ...
    protected override void Update()
    {
        ...
        {
            // 플레이어에게 대미지를 입힙니다.
            /// _player.Hurt(TestDamageValue); -> [v6.0.0] 다음 커밋에서 삭제할 것.
            foreach (PlayerController player in _players)
            {
    ...
    [Obsolete("MainPlayer 프로퍼티로 대체되었습니다.")]
    /// <summary>
    /// 현재 조작중인 플레이어입니다.
    /// </summary>
